        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateChatId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    GroupChatId = table.Column<int>(type: "int", nullable: true),
                    GroupChatId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SenderId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ReplyingToId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChatLines_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeenerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ChatLineId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Seens", x => new { x.ChatLineId, x.SeenerId });
                    table.ForeignKey(
                        name: "FK_Seens_AspNetUsers_SeenerId",
                        column: x => x.SeenerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Seens_ChatLines_ChatLineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatLines_ReplyingToId",
                table: "ChatLines",
                column: "ReplyingToId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatLines_SenderId",
                table: "ChatLines",
                column: "SenderId");
